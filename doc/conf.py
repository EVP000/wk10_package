...
# -*- coding: utf-8 -*-
#
# evp001 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'evp001.tex', 'evp001 Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'evp001', 'evp001 Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'evp001', 'evp001 Documentation',
   'Ariel Rokem', 'evp001', 'One line description of project.',
   'Miscellaneous'),
]
